...
public class Fragment_Data_Proyek extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_fragment_data_proyek, container, false);
        ...
        adapter = new Adapter_Proyek(getActivity(),(ArrayList<Proyek_Model>) list, getContext());
        ...
        StringRequest senddata = new StringRequest(Request.Method.POST, ServerAccess.URL_UNIT_BISNIS + "detailunitbisnis", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(res.getString("dataproyek") != "null") {
                        JSONArray arr = res.getJSONArray("dataproyek");
                        if (arr.length() > 0) {
