...
public class ServerAccess {
    public static final String BASE_URL = "http://192.168.1.15/siprima/";
...
//    public static final String BASE_URL = "https://primagroup.primaitech.com/";
    ...
    public static final String URL_LOGIN=BASE_URL+"/Auth/authlogin";
    ...
    public static final String UPDATE_TOKEN=BASE_URL+"Api/getToken";
