...
public class Form_Pembeli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    Form_Pembeli.this.onBackPressed();
            }
        });
        pd = new ProgressDialog(Form_Pembeli.this);
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Temp_Pembeli.getInstance(getBaseContext()).getTipe_form().equals("edit")){
                    ubah();
                }else{
                    simpan();
                }
        ...
        if (Temp_Pembeli.getInstance(getBaseContext()).getTipe_form().equals("edit")){
            loadJson();
            toolbar.setTitle("Ubah Pembeli");
        }else{
            toolbar.setTitle("Tambah Pembeli");
        }
    }
        ...
        if(nama.equals("")){
            ...
            StringRequest stringRequest = new StringRequest(
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("kode", AuthData.getInstance(Form_Pembeli.this).getAuthKey());
