...
public class Fragment_Rab_Proyek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fragment_rab_proyek);
        ...
        list = new ArrayList<>();
        pd = new ProgressDialog(Fragment_Rab_Proyek.this);
        adapter = new Adapter_RAB(Fragment_Rab_Proyek.this,(ArrayList<RAB_Model>) list, this);
        mManager = new LinearLayoutManager(Fragment_Rab_Proyek.this,LinearLayoutManager.VERTICAL,false);
...
//        kode_menu = bundle.getString("kode_menu");
    ...
    private void loadJson()
    {
        ...
        pd.setCancelable(false);
        pd.show();
        StringRequest senddata = new StringRequest(Request.Method.POST, ServerAccess.URL_RAB+"rabproyek", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                JSONObject res = null;
                try {
